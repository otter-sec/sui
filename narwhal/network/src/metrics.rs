...
pub struct NetworkConnectionMetrics {
    ...
    pub network_peer_max_data: HistogramVec,
    ...
    pub fn new(node: &'static str, registry: &Registry) -> Self {
        Self {
            ...
            network_peer_closed_connections: register_int_gauge_vec_with_registry!(
                ...
                "The total number of closed connections for a peer connection.",
                &["peer_id", "direction"],
                registry
            )
            .unwrap(),
            network_peer_max_data: register_histogram_vec_with_registry!(
                format!("{node}_network_peer_max_data"),
                "The max data for a peer connection.",
                &["peer_id", "direction"],
                SIZE_BYTE_BUCKETS.to_vec(),
                registry
            )
